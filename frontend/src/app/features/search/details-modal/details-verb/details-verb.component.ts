...
export class DetailsVerbComponent implements OnChanges {
  ...
  private extractPronouns(ppConj: string[], pp: string[], ppRefl: string[], ppReflVowel: string[]) {
    ...
    this.versionCopy.inflection.verb.conjunctivImperfect = this.versionCopy.inflection.verb.conjunctivImperfect || {};
    ...
    [this.versionCopy.inflection!.verb!.conjunctivImperfect!.sing1, this.pronouns.conjunctiv2sing1] = this.extractPrefixes(this.versionCopy.inflection!.verb!.conjunctivImperfect?.sing1, [ppConj[0], pp[0], ppRefl[0], ppReflVowel[0], ppConj[6], pp[6], ppConj[7], pp[7]]);
    ...
    [this.versionCopy.inflection!.verb!.conjunctivImperfect!.sing2, this.pronouns.conjunctiv2sing2] = this.extractPrefixes(this.versionCopy.inflection!.verb!.conjunctivImperfect?.sing2, [ppConj[1], pp[1], ppRefl[1], ppReflVowel[1]]);
    ...
    [this.versionCopy.inflection!.verb!.conjunctivImperfect!.sing3, this.pronouns.conjunctiv2sing3] = this.extractPrefixes(this.versionCopy.inflection!.verb!.conjunctivImperfect?.sing3, [ppConj[2], pp[2], ppRefl[2], ppReflVowel[2], ppConj[6], pp[6], ppConj[7], pp[7]]);
    ...
    [this.versionCopy.inflection!.verb!.conjunctivImperfect!.plural1, this.pronouns.conjunctiv2plural1] = this.extractPrefixes(this.versionCopy.inflection!.verb!.conjunctivImperfect?.plural1, [ppConj[3], pp[3], ppRefl[3], ppReflVowel[3]]);
    ...
    [this.versionCopy.inflection!.verb!.conjunctivImperfect!.plural2, this.pronouns.conjunctiv2plural2] = this.extractPrefixes(this.versionCopy.inflection!.verb!.conjunctivImperfect?.plural2, [ppConj[4], pp[4], ppRefl[4], ppReflVowel[4]]);
    ...
    [this.versionCopy.inflection!.verb!.conjunctivImperfect!.plural3, this.pronouns.conjunctiv2plural3] = this.extractPrefixes(this.versionCopy.inflection!.verb!.conjunctivImperfect?.plural3, [ppConj[5], pp[5], ppRefl[5], ppReflVowel[5]]);
